...
public class Listen {
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        Web3j web3j = Web3j.build(new HttpService("http://121.248.55.15:8545"));

        // 要监听的合约地址
        String contractAddress = "0x32e71cc17c8601fdc736edbb016bfc19778491b5";
        ...
        WebSocketService webSocketService = new WebSocketService("ws://121.248.55.15:8546", true);
